...
if First == Second and Second == Third and Third == First: # and - строгий оператор, все условия должны соответсвовать.
    print(3) # 3 - Если все числа равны между собой.
elif First == Second or Second == Third or Third == First: # or - или/или. Хотя бы одо значение должно подходить к условию.
